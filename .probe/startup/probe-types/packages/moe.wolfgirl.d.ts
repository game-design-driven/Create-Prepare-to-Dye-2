...
declare module "packages/moe/wolfgirl/probejs/generated/registry/createdieselgenerators/FuelType" {
import {$RegistryEventJS, $RegistryEventJS$Type} from "packages/dev/latvian/mods/kubejs/registry/$RegistryEventJS"
import {$Object, $Object$Type} from "packages/java/lang/$Object"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class FuelType extends $RegistryEventJS<($Object)> {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type FuelType$Type = (FuelType);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
