import {$ConfigEventJS, $ConfigEventJS$Type} from "packages/com/notenoughmail/configjs/$ConfigEventJS"
...
import {$MoldEventJS, $MoldEventJS$Type} from "packages/com/jesz/createdieselgenerators/compat/kubejs/$MoldEventJS"
...
export namespace ConfigsEvent {
function server(handler: (event: $ConfigEventJS) => void): void
function common(handler: (event: $ConfigEventJS) => void): void
function client(handler: (event: $ConfigEventJS) => void): void
}
