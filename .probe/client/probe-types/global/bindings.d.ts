...
import {$Bindings, $Bindings$Type} from "packages/com/notenoughmail/configjs/$Bindings"
...
import {$InputWindowElement, $InputWindowElement$Type} from "packages/net/createmod/ponder/foundation/element/$InputWindowElement"
...
export import ParrotElement = $ParrotElement
